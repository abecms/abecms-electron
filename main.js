...
let env = { ...process.env, PATH: `${process.env.PATH}:/usr/local/bin` };
...
const launchServer = () => {
  ...
  nodeServer = spawn("./node_modules/node/bin/node", ["./node_modules/abecms/dist/server/index.js"], { env: env, cwd: app.getAppPath() });
  //nodeServer = fork(require.resolve('./node_modules/abecms/dist/server/index.js'), [], { env: env, cwd: app.getAppPath(), silent: true });
